...
const EmptyState = ({
  ...
  text = "There is no data to display right now.",
}) => (
...
const SuperAdminDashboard = () => {
  ...
  const quickActions = [
    {
      title: "Create Quiz",
      description: "Create a new quiz and configure title, code, and schedule.",
      to: "/create-quiz",
    ...
    },
    {
      ...
      description: "Review all quizzes, update records, and monitor status.",
      to: "/quizzes",
      icon: <ListChecks size={16} />,
    },
    {
      title: "Add Question",
      description: "Add new questions and define answer logic quickly.",
      to: "/add-question",
  ...
  return (
    <>
      <header style={styles.header}>
        <div>
          <p style={styles.headerEyebrow}>Super Admin Panel</p>
          <h2 style={styles.headerTitle}>
            Welcome back, {user?.name || "Super Admin"}
          </h2>
          <p style={styles.headerText}>
            Get a complete platform-level view of quiz activity, status
            distribution, recent updates, and key administrative actions.
          </p>
        </div>
      ...
      {loading && (
        <div style={styles.stateCard}>
          ...
          <p style={styles.stateText}>
            Fetching platform data and preparing insights.
          </p>
        </div>
      )}
              ...
              <div style={styles.panelHeader}>
                <div>
                  ...
                  <p style={styles.panelText}>
                    Total quizzes created over the last 6 months.
                  </p>
                </div>
              </div>
            ...
            <div style={styles.panel}>
              <div style={styles.panelHeader}>
                <div>
                  ...
                  <p style={styles.panelText}>
                    Current platform-wide quiz status breakdown.
                  </p>
                </div>
              </div>
              ...
              {dashboardData.pieData.length > 0 ? (
                ...
                <EmptyState
                  ...
                  text="Status distribution will appear here once quizzes are available."
                />
              )}
            </div>
          </section>
          ...
          <section style={styles.contentGrid}>
            <div style={styles.panel}>
              <div style={styles.panelHeader}>
                <div>
                  ...
                  <p style={styles.panelText}>
                    Recently created or updated quizzes across the system.
                  </p>
                </div>
              </div>
                    ...
                    return (
                      <div key={quiz._id} style={styles.recentItem}>
                        ...
                        <div style={styles.recentMeta}>
                          ...
                          <span>
                            {formatDate(quiz.createdAt || quiz.updatedAt)}
                          </span>
                        </div>
                      </div>
                    );
            ...
            <div style={styles.sideColumn}>
              <div style={styles.panel}>
                <div style={styles.panelHeader}>
                  <div>
                    ...
                    <p style={styles.panelText}>
                      Frequently used super admin actions.
                    </p>
                  </div>
                </div>
              ...
              <div style={styles.panel}>
                <div style={styles.panelHeader}>
                  <div>
                    ...
                    <p style={styles.panelText}>
                      Current identity and admin access details.
                    </p>
                  </div>
                </div>
                ...
                <div style={styles.summaryList}>
                  ...
                  <div style={styles.summaryRow}>
                    <span style={styles.summaryKey}>Access Level</span>
                    <span style={styles.summaryValue}>Full platform control</span>
                  </div>
              ...
              <div style={styles.panel}>
                <div style={styles.panelHeader}>
                  <div>
                    <h3 style={styles.panelTitle}>Admin overview</h3>
                    <p style={styles.panelText}>
                      High-level guidance for managing the platform.
                    </p>
                  </div>
                </div>
                ...
                <div style={styles.noteBox}>
                  ...
                  <div>
                    <p style={styles.noteTitle}>Platform control center</p>
                    <p style={styles.noteText}>
                      Use this dashboard to monitor quizzes, manage records, and
                      maintain operational visibility from one place.
                    </p>
                  </div>
                </div>
              </div>
